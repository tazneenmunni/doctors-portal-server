...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.mydyh.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
    ...
    *app.delete('/booking/:id') 
     */
        ...
        app.post('/booking', async (req, res) => {
            ...
            return res.send({ succes: true, result })
        })
    }
    finally {
